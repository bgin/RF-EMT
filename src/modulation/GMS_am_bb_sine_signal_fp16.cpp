...
gms::radiolocation
::am_bb_sine_signal_fp16_t
::am_bb_sine_signal_fp16_t(const std::size_t nsamples,
...
gms::radiolocation
::am_bb_sine_signal_fp16_t
::am_bb_sine_signal_fp16_t(am_bb_sine_signal_fp16_t &&other) noexcept(true)
:
...
gms::radiolocation
::am_bb_sine_signal_fp16_t
::am_bb_sine_signal_fp16_t(const am_bb_sine_signal_fp16_t &other) noexcept(false)
:
...
gms::radiolocation
::am_bb_sine_signal_fp16_t
::operator=(am_bb_sine_signal_fp16_t &&other) noexcept(true)
{
...
::operator<<(std::ostream &os,
             gms::radiolocation::am_bb_sine_signal_fp16_t &rhs)->std::ostream &
{
