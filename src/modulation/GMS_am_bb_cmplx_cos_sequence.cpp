                             ...
                             const std::uint32_t                  which_generator)
{
        ...
        for(i = 0ull; (i+63ull) < this->m_nsamples/2ull; i += 64ull) 
        {
              sum0_r = vzero;
              sum0_i = vzero;
              sum1_r = vzero;
              ...
              for(; (i+39ull) < this->m_nsamples/2ull; i += 40ull) 
              {
                       sum0_r = vzero;
                       sum0_i = vzero;
                       sum1_r = vzero;
               ...
               for(; (i+31ull) < this->m_nsamples/2; i += 32ull) 
               {
                       sum0_r = vzero;
                       sum0_i = vzero;
                       sum1_r = vzero;
               ...
               for(; (i+15ull) < this->m_nsamples/2; i += 16ull) 
               {
                       sum0_r = vzero;
                       sum0_i = vzero;
                       sum1_r = vzero;
               ...
               for(; (i+7ull) < this->m_nsamples/2; i += 8ull) 
               {
                       sum0_r = vzero;
                       sum0_i = vzero;
                       sum1_r = vzero;
              ...
              for(; (i+3ull) < this->m_nsamples/2; i += 4ull) 
              {
                       sum0_r = vzero;
                       sum0_i = vzero;
                       for(std::size_t j{0ull}; j != this->m_nsignals; ++j)  
              ...
              for(; (i+0ull) < this->m_nsamples/2; i += 1ull) 
              {
                   sum_rem_r = 0.0f;
                   sum_rem_i = 0.0f;
                             ...
                             const std::uint32_t                  which_generator)
{
        ...
        for(i = 0ull; (i+39ull) < this->m_nsamples/2ull; i += 40ull) 
        {
              sum0_r = vzero;
              sum0_i = vzero;
              sum1_r = vzero;
                             ...
                             const std::uint32_t                  which_generator)
{
        ...
        for(i = 0ull; (i+23ull) < this->m_nsamples/2ull; i += 24ull) 
        {
              sum0_r = vzero;
              sum0_i = vzero;
              sum1_r = vzero;
                             ...
                             const std::uint32_t                  which_generator)
{
        ...
        for(i = 0ull; (i+127ull) < this->m_nsamples/2ull; i += 128ull) 
        {
              ...
              for(; (i+95ull) < this->m_nsamples/2ull; i += 96ull) 
              {
                        sum0_r = vzero;
                        sum0_i = vzero;
                        sum1_r = vzero;
            ...
            for(; (i+79ull) < this->m_nsamples/2ull; i += 80ull) 
            {
                        sum0_r = vzero;
                        sum0_i = vzero;
                        sum1_r = vzero;
            ...
            for(; (i+63ull) < this->m_nsamples/2ull; i += 64ull) 
            {
                        sum0_r = vzero;
                        sum0_i = vzero;
                        sum1_r = vzero;
            ...
            for(; (i+31ull) < this->m_nsamples/2ull; i += 32ull) 
            {
                        sum0_r = vzero;
                        sum0_i = vzero;
                        sum1_r = vzero;
            ...
            for(; (i+15ull) < this->m_nsamples/2ull; i += 16ull) 
            {
                        sum0_r = vzero;
                        sum0_i = vzero;
                        sum1_r = vzero;
            ...
            for(; (i+7ull) < this->m_nsamples/2ull; i += 8ull) 
            {
                        sum0_r = vzero;
                        sum0_i = vzero;
                             ...
                             const std::uint32_t                  which_generator)
{
        ...
        for(i = 0ull; (i+79ull) < this->m_nsamples/2ull; i += 80ull) 
        {
              sum0_r = vzero;
              sum0_i = vzero;
              sum1_r = vzero;
                             ...
                             const std::uint32_t                  which_generator)
{
        ...
        for(i = 0ull; (i+47ull) < this->m_nsamples/2ull; i += 48ull) 
        {
              sum0_r = vzero;
              sum0_i = vzero;
              sum1_r = vzero;
