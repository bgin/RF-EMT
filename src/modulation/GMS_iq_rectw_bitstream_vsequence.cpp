...
gms::radiolocation
::iq_rectw_bitstream_vsequence_t
::generate_iq_rectw_bitstream_sequence_sse_u16x(const std::int32_t * ret_codes)
{
        ...
        if(this->m_I_nsamples==this->m_Q_nsamples)
        {
              for(i = 0ull; (i+63ull) < this->m_I_nsamples; i += 64ull) 
              {
                    ...
                    for(std::size_t j{0ull}; j != this->m_IQ_nsignals; ++j)  
                    {
                        ...
                        sum10_q   = _mm_load_ps(xmm10_q[j],sum10_q);
                        ...
                        sum11_q   = _mm_load_ps(xmm11_q[j],sum11_q);
                        ...
                        sum12_q   = _mm_load_ps(xmm12_q[j],sum12_q);
                        ...
                        sum13_q   = _mm_load_ps(xmm13_q[j],sum13_q);
                        ...
                        sum14_q   = _mm_load_ps(xmm14_q[j],sum14_q);
                        ...
                        sum15_q   = _mm_load_ps(xmm15_q[j],sum15_q);
...
::generate_iq_rectw_bitstream_sequence_sse_u16x<gms::radiolocation::
                                              ...
                                              std::size_t nsignals_size>(const std::int32_t * __restrict__);
...
gms::radiolocation
::iq_rectw_bitstream_vsequence_t
::generate_iq_rectw_bitstream_sequence_sse_u10x(const std::int32_t * ret_codes)
{
       if(__builtin_expect(nullptr==ret_codes,0)) { return (-1);}
...
gms::radiolocation
::iq_rectw_bitstream_vsequence_t
::generate_iq_rectw_bitstream_sequence_sse_u6x(const std::int32_t * ret_codes)
{
       if(__builtin_expect(nullptr==ret_codes,0)) { return (-1);}
...
gms::radiolocation
::iq_rectw_bitstream_vsequence_t
::generate_iq_rectw_bitstream_sequence_avx_u16x(const std::int32_t * ret_codes)
{
       if(__builtin_expect(nullptr==ret_codes,0)) { return (-1);}
        ...
        if(this->m_I_nsamples==this->m_Q_nsamples)
        {
              for(i = 0ull; (i+127ull) < this->m_I_nsamples; i += 128ull) 
              {
                    ...
                    for(std::size_t j{0ull}; j != this->m_IQ_nsignals; ++j)  
                    {
                        ...
                        sum0_q    = _mm256_load_ps(xmm0_q[j],sum0_q);
                        ...
                        sum1_q    = _mm256_load_ps(xmm1_q[j],sum1_q);
                        ...
                        sum2_q    = _mm256_load_ps(xmm2_q[j],sum2_q);
                        ...
                        sum3_q    = _mm256_load_ps(xmm3_q[j],sum3_q);
                        ...
                        sum4_q    = _mm256_load_ps(xmm4_q[j],sum4_q);
                        ...
                        sum5_q    = _mm256_load_ps(xmm5_q[j],sum5_q);
                        ...
                        sum6_q    = _mm256_load_ps(xmm6_q[j],sum6_q);
                        ...
                        sum7_q    = _mm256_load_ps(xmm7_q[j],sum7_q);
                        ...
                        sum8_q    = _mm256_load_ps(xmm8_q[j],sum8_q);
                        ...
                        sum9_q    = _mm256_load_ps(xmm9_q[j],sum9_q);
                        ...
                        sum10_q   = _mm256_load_ps(xmm10_q[j],sum10_q);
                        ...
                        sum11_q   = _mm256_load_ps(xmm11_q[j],sum11_q);
                        ...
                        sum12_q   = _mm256_load_ps(xmm12_q[j],sum12_q);
                        ...
                        sum13_q   = _mm256_load_ps(xmm13_q[j],sum13_q);
                        ...
                        sum14_q   = _mm256_load_ps(xmm14_q[j],sum14_q);
                        ...
                        sum15_q   = _mm256_load_ps(xmm15_q[j],sum15_q);
...
gms::radiolocation
::iq_rectw_bitstream_vsequence_t
::generate_iq_rectw_bitstream_sequence_avx_u10x(const std::int32_t * ret_codes)
{
       if(__builtin_expect(nullptr==ret_codes,0)) { return (-1);}
...
gms::radiolocation
::iq_rectw_bitstream_vsequence_t
::generate_iq_rectw_bitstream_sequence_avx_u6x(const std::int32_t * ret_codes)
{
       if(__builtin_expect(nullptr==ret_codes,0)) { return (-1);}
...
gms::radiolocation
::iq_rectw_bitstream_vsequence_t
::generate_iq_rectw_bitstream_sequence_avx512_u16x(const std::int32_t * ret_codes)
{
       if(__builtin_expect(nullptr==ret_codes,0)) { return (-1);}
        ...
        if(this->m_I_nsamples==this->m_Q_nsamples)
        {
              for(i = 0ull; (i+255ull) < this->m_I_nsamples; i += 256ull) 
              {
                    ...
                    for(std::size_t j{0ull}; j != this->m_IQ_nsignals; ++j)  
                    {
                        ...
                        sum0_q    = _mm512_load_ps(xmm0_q[j],sum0_q);
                        ...
                        sum1_q    = _mm512_load_ps(xmm1_q[j],sum1_q);
                        ...
                        sum2_q    = _mm512_load_ps(xmm2_q[j],sum2_q);
                        ...
                        sum3_q    = _mm512_load_ps(xmm3_q[j],sum3_q);
                        ...
                        sum4_q    = _mm512_load_ps(xmm4_q[j],sum4_q);
                        ...
                        sum5_q    = _mm512_load_ps(xmm5_q[j],sum5_q);
                        ...
                        sum6_q    = _mm512_load_ps(xmm6_q[j],sum6_q);
                        ...
                        sum7_q    = _mm512_load_ps(xmm7_q[j],sum7_q);
                        ...
                        sum8_q    = _mm512_load_ps(xmm8_q[j],sum8_q);
                        ...
                        sum9_q    = _mm512_load_ps(xmm9_q[j],sum9_q);
                        ...
                        sum10_q   = _mm512_load_ps(xmm10_q[j],sum10_q);
                        ...
                        sum11_q   = _mm512_load_ps(xmm11_q[j],sum11_q);
                        ...
                        sum12_q   = _mm512_load_ps(xmm12_q[j],sum12_q);
                        ...
                        sum13_q   = _mm512_load_ps(xmm13_q[j],sum13_q);
                        ...
                        sum14_q   = _mm512_load_ps(xmm14_q[j],sum14_q);
                        ...
                        sum15_q   = _mm512_load_ps(xmm15_q[j],sum15_q);
...
gms::radiolocation
::iq_rectw_bitstream_vsequence_t
::generate_iq_rectw_bitstream_sequence_avx512_u10x(const std::int32_t * ret_codes)
{
       if(__builtin_expect(nullptr==ret_codes,0)) { return (-1);}
