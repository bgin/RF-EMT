        ...
        if(this->m_nsamples > exceeds_L1D_size)
        {
             for(i = 0ull; (i+63ull) < n_samples_halved; i += 64ull) 
             {
              ...
              for(std::size_t j{0ull}; j != this->m_nsignals; ++j)  
              {
                      ...
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+4ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+4ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+8ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+8ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+12ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+12ull],_MM_HINT_T1);
                      ...
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+20ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+20ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+24ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+24ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+28ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+28ull],_MM_HINT_T1);
                      ...
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+36ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+36ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+40ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+40ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+44ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+44ull],_MM_HINT_T1);
                      ...
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+52ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+52ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+56ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+56ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+60ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+60ull],_MM_HINT_T1);
#endif 
        ...
        if(this->m_nsamples > exceeds_L1D_size)
        {
            ...
            for(i = 0ull; (i+127ull) < n_samples_halved; i += 128ull) 
            {
              ...
              for(std::size_t j{0ull}; j != this->m_nsignals; ++j)  
              {
                      ...
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+72ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+72ull],_MM_HINT_T1);
                      ...
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+88ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+88ull],_MM_HINT_T1);
                      ...
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+104ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+104ull],_MM_HINT_T1);
                      ...
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_I_channel()[i+120ull],_MM_HINT_T1);
                      _mm_prefetch((const char*)&this->m_bb_cmplx_sinc_signals.operator[](j).get_Q_channel()[i+120ull],_MM_HINT_T1);
#endif 
