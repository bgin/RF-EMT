...
gms::radiolocation
::am_bb_cmplx_sin_signal_t
::am_bb_cmplx_sin_signal_t(const std::size_t nsamples,
...
gms::radiolocation
::am_bb_cmplx_sin_signal_t
::am_bb_cmplx_sin_signal_t(am_bb_cmplx_sin_signal_t &&other) noexcept(true)
:
...
gms::radiolocation
::am_bb_cmplx_sin_signal_t
::operator=(am_bb_cmplx_sin_signal_t &&other) noexcept(true)
{
...
gms::radiolocation
::am_bb_cmplx_sin_signal_t
::create_noisy_signal_user_data(am_bb_cmplx_sin_signal_pdf_params_t & pdf_params,
                                const float scale,
...
::am_bb_cmplx_sin_signal_t
::create_noisy_signal_user_data(am_bb_cmplx_sin_signal_pdf_params_t & pdf_params,
                                am_bb_cmplx_sin_signal_rand_distr rd_enum,
                                const float scale,
                                const float * __restrict__ sym_in, // size of m_nsamples*m_nK values [0,1]
                                const std::uint32_t n_T,
                                const std::uint32_t n_K)
{
     if(__builtin_expect(static_cast<std::uint32_t>(this->m_nsamples)!=n_T,0) || 
      ...
      switch (rd_enum)
      {
        case am_bb_cmplx_sin_signal_rand_distr::uniform : 
              tsc = __rdtsc();
        ...
        break;
        case am_bb_cmplx_sin_signal_rand_distr::normal : 
              tsc = __rdtsc();
         ...
         break;
         case am_bb_cmplx_sin_signal_rand_distr::cauchy : 
                tsc = __rdtsc();
         ...
         break;
         case am_bb_cmplx_sin_signal_rand_distr::log_norm : 
               tsc = __rdtsc();
         ...
         break;
         case am_bb_cmplx_sin_signal_rand_distr::expo_gamma : 
               tsc = __rdtsc();
          ...
          break;
          case am_bb_cmplx_sin_signal_rand_distr::weibull : 
                 tsc = __rdtsc();
          ...
          break;
          case am_bb_cmplx_sin_signal_rand_distr::gamma : 
                 tsc = __rdtsc();
...
::operator<<(std::ostream &os,
             gms::radiolocation::am_bb_cmplx_sin_signal_t &rhs)->std::ostream &
{
