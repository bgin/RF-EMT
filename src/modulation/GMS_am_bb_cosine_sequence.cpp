                               ...
                               std::int32_t * __restrict__ ret_code) 
{
...
#endif 
               xmm0[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+0ull]);
               sum0  =  _mm_add_ps(xmm0[j],sum0);
               xmm1[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+4ull]);
               sum1  =  _mm_add_ps(xmm1[j],sum1);
               xmm2[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+8ull]);
               sum2  =  _mm_add_ps(xmm2[j],sum2);
               xmm3[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+12ull]);
               sum3  =  _mm_add_ps(xmm3[j],sum3);
               xmm4[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+16ull]);
               sum4  =  _mm_add_ps(xmm4[j],sum4);
               xmm5[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+20ull]);
               sum5  =  _mm_add_ps(xmm5[j],sum5);
               xmm6[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+24ull]);
               sum6  =  _mm_add_ps(xmm6[j],sum6);
               xmm7[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+28ull]);
               sum7  =  _mm_add_ps(xmm7[j],sum7);
               xmm8[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+32ull]);
               sum8  =  _mm_add_ps(xmm8[j],sum8);
               xmm9[j]  =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+36ull]);
               sum9  =  _mm_add_ps(xmm9[j],sum9);
               xmm10[j] =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+40ull]);
               sum10 =  _mm_add_ps(xmm10[j],sum10);
               xmm11[j] =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+44ull]);
               sum11 =  _mm_add_ps(xmm11[j],sum11);
               xmm1[j] =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+48ull]);
               sum12 =  _mm_add_ps(xmm12[j],sum12);
               xmm13[j] =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+52ull]);
               sum13 =  _mm_add_ps(xmm13[j],sum13);
               xmm14[j] =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+56ull]);
               sum14 =  _mm_add_ps(xmm14[j],sum14);
               xmm15[j] =  _mm_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+60ull]);
        ...
        for(; (i+0ull) < this->m_nsamples; i += 1ull) 
        {
            ...
            for(std::size_t j{0ull}; j != this->m_nsignals; ++j) 
            {
               ...
               scal_rem[j]   =  this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i];
               sum_rem  +=  scal_rem[j];
        ...
        for(i = 0ull; (i+127ull) < this->m_nsamples; i += 128ull) 
        {
              ...
              for(std::size_t j{0ull}; j != this->m_nsignals; ++j)  
              {
               ...
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+120ull],_MM_HINT_T1);
                    ...
                    ymm0[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+0ull]);
                    sum0  =  _mm256_add_ps(ymm0[j],sum0);
                    ymm1[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+8ull]);
                    sum1  =  _mm256_add_ps(ymm1[j],sum1);
                    ymm2[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+16ull]);
                    sum2  =  _mm256_add_ps(ymm2[j],sum2);
                    ymm3[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+24ull]);
                    sum3  =  _mm256_add_ps(ymm3[j],sum3);
                    ymm4[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+32ull]);
                    sum4  =  _mm256_add_ps(ymm4[j],sum4);
                    ymm5[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+40ull]);
                    sum5  =  _mm256_add_ps(ymm5[j],sum5);
                    ymm6[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+48ull]);
                    sum6  =  _mm256_add_ps(ymm6[j],sum6); 
                    ymm7[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+56ull]);
                    sum7  =  _mm256_add_ps(ymm7[j],sum7);
                    ymm8[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+64ull]);
                    sum8  =  _mm256_add_ps(ymm8[j],sum8);
                    ymm9[j]  =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+72ull]);
                    sum9  =  _mm256_add_ps(ymm9[j],sum9);
                    ymm10[j] =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+80ull]);
                    sum10 =  _mm256_add_ps(ymm10[j],sum10);
                    ymm11[j] =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+88ull]);
                    sum11 =  _mm256_add_ps(ymm11[j],sum11);
                    ymm12[j] =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+96ull]);
                    sum12 =  _mm256_add_ps(ymm12[j],sum12);
                    ymm13[j] =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+104ull]);
                    sum13 =  _mm256_add_ps(ymm13[j],sum13);
                    ymm14[j] =  _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+112ull]);
                    sum14 =  _mm256_add_ps(ymm14[j],sum14);
                    ymm15[j]  = _mm256_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+120ull]);
        ...
        for(i = 0ull; (i+47ull) < this->m_nsamples; i += 48ull) 
        {
              ...
              for(std::size_t j{0ull}; j != this->m_nsignals; ++j)  
              {
               ...
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+40ull],_MM_HINT_T1);
                    ...
                    ymm0[j]  =  _mm256_load_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+0ull]);
                    sum0  =  _mm256_add_ps(ymm0[j],sum0);
                    ymm1[j]  =  _mm256_load_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+8ull]);
                    sum1  =  _mm256_add_ps(ymm1[j],sum1);
                    ymm2[j]  =  _mm256_load_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+16ull]);
                    sum2  =  _mm256_add_ps(ymm2[j],sum2);
                    ymm3[j]  =  _mm256_load_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+24ull]);
                    sum3  =  _mm256_add_ps(ymm3[j],sum3);
                    ymm4[j]  =  _mm256_load_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+32ull]);
                    sum4  =  _mm256_add_ps(ymm4[j],sum4);
                    ymm5[j]  =  _mm256_load_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+40ull]);
                    sum5  =  _mm256_add_ps(ymm5[j],sum5);
                                ...
                                std::int32_t * __restrict__ ret_codes) 
{
        ...
        for(i = 0ull; (i+255ull) < this->m_nsamples; i += 256ull) 
        {
              ...
              for(std::size_t j{0ull}; j != this->m_nsignals; ++j)  
              {
               ...
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+96ull],_MM_HINT_T1);
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+112ull],_MM_HINT_T1);
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+128ull],_MM_HINT_T1);
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+144ull],_MM_HINT_T1);
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+160ull],_MM_HINT_T1);
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+176ull],_MM_HINT_T1);
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+192ull],_MM_HINT_T1);
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+208ull],_MM_HINT_T1);
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+224ull],_MM_HINT_T1);
               _mm_prefetch((const char*)&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+240ull],_MM_HINT_T1);
                                          
#endif 
                   
                    zmm0[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+0ull]);
                    sum0  =  _mm512_add_ps(zmm0[j],sum0);
                    zmm1[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+16ull]);
                    sum1  =  _mm512_add_ps(zmm1[j],sum1);
                    zmm2[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+32ull]);
                    sum2  =  _mm512_add_ps(zmm2[j],sum2);
                    zmm3[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+48ull]);
                    sum3  =  _mm512_add_ps(zmm3[j],sum3);
                    zmm4[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+64ull]);
                    sum4  =  _mm512_add_ps(zmm4[j],sum4);
                    zmm5[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+80ull]);
                    sum5  =  _mm512_add_ps(zmm5[j],sum5);
                    zmm6[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+96ull]);
                    sum6  =  _mm512_add_ps(zmm6[j],sum6); 
                    zmm7[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+112ull]);
                    sum7  =  _mm512_add_ps(zmm7[j],sum7);
                    zmm8[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+128ull]);
                    sum8  =  _mm512_add_ps(zmm8[j],sum8);
                    zmm9[j]  =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+144ull]);
                    sum9  =  _mm512_add_ps(zmm9[j],sum9);
                    zmm10[j] =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+160ull]);
                    sum10 =  _mm512_add_ps(zmm10[j],sum10);
                    zmm11[j] =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+176ull]);
                    sum11 =  _mm512_add_ps(zmm11[j],sum11);
                    zmm12[j] =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+192ull]);
                    sum12 =  _mm512_add_ps(zmm12[j],sum12);
                    zmm13[j] =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+208ull]);
                    sum13 =  _mm512_add_ps(zmm13[j],sum13);
                    zmm14[j] =  _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+224ull]);
                    sum14 =  _mm512_add_ps(zmm14[j],sum14);
                    zmm15[j]  = _mm512_loadu_ps(&this->m_bb_cos_signals.operator[](j).m_sig_samples.m_data[i+240ull]);
