...
#if (RECTANGULAR_WAVEFORM_FP16_USE_CEPHES) == 0
#include <cmath>
#endif 

#if (RECTANGULAR_WAVEFORM_FP16_USE_CEPHES) == 1
...
gms::radiolocation
::rectangular_waveform_fp16_t
::rectangular_waveform_fp16_t(const std::size_t n_samples,
...
gms::radiolocation
::rectangular_waveform_fp16_t
::rectangular_waveform_fp16_t(rectangular_waveform_fp16_t &&other) noexcept(true)
:
...
gms::radiolocation
::rectangular_waveform_fp16_t
::rectangular_waveform_fp16_t(const rectangular_waveform_fp16_t &other) noexcept(false)
:
__n_samples__{other.__n_samples__},
__n_waves__{other.__n_waves__},
__T__{other.__T__},
__rho__{other.__rho__},
__A__{other.__A__},
__rw_samples__{other.__rw_samples__}
{
...
gms::radiolocation
::rectangular_waveform_fp16_t
::operator=(rectangular_waveform_fp16_t &&other)
{
...
::init_storage(const half_float::half filler)
{
	 ...
	 sse_memset_unroll8x_ps(reinterpret_cast<float*>(this->__rw_samples__.m_data),filler,this->__n_samples__);
#else 
    ...
    switch (which_index)
    {
         case 0 : 
             for(std::uint32_t __i{0}; __i != n_samples; ++__i) 
             {
                  ...
                  this->__rw_samples__.m_data[__i] = half_cast<half>((this->__A__*rho_over_T)+twoA_over_PI*sum);
             }
         break;
         case 1 : 
