...
/*
   icpc -o perf_test_mm512_cephes_cos_ps_64B -O3 -fp-model fast=2 -fno-exceptions -fopenmp  -std=c++17 -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_ansi_colors.h GMS_simd_cephes_cos.h perf_test_mm512_cephes_cos_ps_64B.cpp
   ASM: 
   icpc -S --O3 fverbose-asm -masm=intel  -fno-exceptions -fopenmp  -std=c++17 -march=skylake-avx512 -mavx512f -falign-functions=32 GMS_config.h GMS_ansi_colors.h  GMS_simd_cephes_cos.h perf_test_mm512_cephes_cos_ps_64B.cpp
...
void perf_test_mm512_cephes_cos_ps_64B(__m512,
                                       __m512 * __restrict__,
...
__attribute__((hot))
__attribute__((noinline))
void perf_test_mm512_cephes_cos_ps_64B(__m512 cos_args,
...
*/
    ...
    // warmup call of _mm512_cephes_cosf_ps
    __m512 a_cos_args = cos_args;
    warmup_cos_values = gms::math::_mm512_ceph_cosf_ps(a_cos_args);
    ...
    for(int32_t __i{0}; __i != n_runs; ++__i)
    {
        ...
        {   
            ...
            result_cos_values = gms::math::_mm512_ceph_cosf_ps(a_cos_args);
...
#pragma omp parallel sections 
{
    ...
    #pragma omp section 
    {
        perf_test_mm512_cephes_cos_ps_64B(in_vec_cos_arg,
                                          &cephes_cos_results,
                                          &cephes_cos_ps_s[0],
                                          &cephes_cos_ps_e[0],
                                          &cephes_cos_ps_d[0],
     ...
     printf(ANSI_COLOR_BLUE "[PERF-TEST]: _mm512_cephes_cosf_ps: Finished -- dumping-results" ANSI_RESET_ALL"\n\n");
