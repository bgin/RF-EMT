...
/*
   icpc -o unit_test_am_bb_cmplx_cos_sequence_sse -O3 -fp-model fast=2 -std=c++17 -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_cos.h GMS_indices.h GMS_am_bb_cmplx_cos_signal.h GMS_am_bb_cmplx_cos_signal.cpp GMS_am_bb_cmplx_cos_sequence.h GMS_am_bb_cmplx_cos_sequence.cpp unit_test_am_bb_cmplx_cos_sequence_sse.cpp
   ASM: 
   icpc -S --O3 fverbose-asm -masm=intel  -std=c++17 -march=skylake-avx512 -mavx512f -falign-functions=32 GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_cos.h GMS_indices.h GMS_am_bb_cmplx_cos_signal.h GMS_am_bb_cmplx_cos_signal.cpp GMS_am_bb_cmplx_cos_sequence.h GMS_am_bb_cmplx_cos_sequence.cpp unit_test_am_bb_cmplx_cos_sequence_sse.cpp
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cmplx_cos_sequence_correctness_sse_u16x();
...
void unit_test_am_bb_cmplx_cos_sequence_correctness_sse_u16x()
{
   ...
   //  const std::size_t   nsignals{rand_nsignals.operator()()};
     ...
     am_bb_cmplx_cos_signal_sequence_t cos_sequence = am_bb_cmplx_cos_signal_sequence_t(I_n_samples,
                                                                                         nsignals,nK_values,
                                                                                        n_values,A_values,P_values);
     am_bb_cmplx_cos_signal_t symbol_1 = am_bb_cmplx_cos_signal_t(I_n_samples,I_n_K,n,A,P);
     am_bb_cmplx_cos_signal_t symbol_2 = am_bb_cmplx_cos_signal_t(I_n_samples,I_n_K,n,A,P);
     am_bb_cmplx_cos_signal_t symbol_3 = am_bb_cmplx_cos_signal_t(I_n_samples,I_n_K,n,A,P);
     am_bb_cmplx_cos_signal_t symbol_4 = am_bb_cmplx_cos_signal_t(I_n_samples,I_n_K,n,A,P);
     ...
     for(std::uint32_t i_case{0u}; i_case != 4u; ++i_case) 
     {
         ...
         std::int32_t ret_stat = cos_sequence.signal_sequence_sse42_u16x(&I_sym.m_data[0],pdf_params,am_bb_cmplx_cos_signal_rand_distr::cauchy,&rand_scales[0],&ret_codes.operator[](0),i_case);
         if(ret_stat<0) { 
         ...
         if(i_case==0u)
         {
            ...
            signal_sequence_vertical_summation(&symbol_1.get_Q_channel()[0],
                                        ...
                                        I_n_samples/2ull);                                   
            check_fp_approx_equality(&cos_sequence.m_re_sequence.m_data[0],
                             &sig_vsum_reference_re.m_data[0],I_n_samples/2ull);
            check_fp_approx_equality(&cos_sequence.m_im_sequence.m_data[0],
         ...
         { 
            ...
            std::string s1 = "am_bb_cmplx_cos_seq_sse_u16x_re_correct_test_1_case_"+std::to_string(i_case);
            std::string s2 = "am_bb_cmplx_cos_signal_reference_vsumm_re_u16x_test_1_"+std::to_string(i_case);
         
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_re_sequence.m_data[0],nullptr,
                                              s1.c_str(),"AM-BB_cos_signals_sequence",false);
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(I_n_samples/2ull,&sig_vsum_reference_re.m_data[0],nullptr,
                                               s2.c_str(),"AM-BB_cos_signals_sequence",false);
            std::string s3 = "am_bb_cmplx_cos_seq_sse_u16x_im_correct_test_1_"+std::to_string(i_case);
            std::string s4 = "am_bb_cmplx_cos_signal_reference_vsumm_im_u16x_test_1_"+std::to_string(i_case);
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_im_sequence.m_data[0],nullptr,
                                              s3.c_str(),"AM-BB_cos_signals_sequence",false);
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(I_n_samples/2ull,&sig_vsum_reference_im.m_data[0],nullptr,
                                              s4.c_str() ,"AM-BB_cos_signals_sequence",false);  
         }
         gms::common::sse_memset_unroll8x_ps(&cos_sequence.m_re_sequence.m_data[0],0.0f,I_n_samples/2ull);
         gms::common::sse_memset_unroll8x_ps(&sig_vsum_reference_re.m_data[0],0.0f,I_n_samples/2ull);
         gms::common::sse_memset_unroll8x_ps(&cos_sequence.m_im_sequence.m_data[0],0.0f,I_n_samples/2ull);
         gms::common::sse_memset_unroll8x_ps(&sig_vsum_reference_im.m_data[0],0.0f,I_n_samples/2ull);  
         std::memset(&ret_codes[0],0,cos_sequence.m_nsignals);
     }
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cmplx_cos_sequence_correctness_sse_u10x();
...
void unit_test_am_bb_cmplx_cos_sequence_correctness_sse_u10x()
{
   ...
   //  const std::size_t   nsignals{rand_nsignals.operator()()};
     ...
     for(std::uint32_t i_case{0u}; i_case != 4u; ++i_case) 
     {
         ...
         std::int32_t ret_stat = cos_sequence.signal_sequence_sse42_u10x(&I_sym.m_data[0],pdf_params,am_bb_cmplx_cos_signal_rand_distr::cauchy,&rand_scales[0],&ret_codes.operator[](0),i_case);
         if(ret_stat<0) { 
         ...
         { 
            std::printf("[UNIT-TEST:] -- case=%d, plotting results\n",i_case);
            std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
            std::string s1 = "am_bb_cmplx_cos_seq_sse_u10x_re_correct_test_1_case_"+std::to_string(i_case);
            std::string s2 = "am_bb_cmplx_cos_signal_reference_vsumm_re_u10x_test_1_"+std::to_string(i_case);
         
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_re_sequence.m_data[0],nullptr,
                                              s1.c_str(),"AM-BB_cos_signals_sequence",false);
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(I_n_samples/2ull,&sig_vsum_reference_re.m_data[0],nullptr,
                                               s2.c_str(),"AM-BB_cos_signals_sequence",false);
            std::string s3 = "am_bb_cmplx_cos_seq_sse_u10x_im_correct_test_1_"+std::to_string(i_case);
            std::string s4 = "am_bb_cmplx_cos_signal_reference_vsumm_im_u10x_test_1_"+std::to_string(i_case);
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_im_sequence.m_data[0],nullptr,
                                              s3.c_str(),"AM-BB_cos_signals_sequence",false);
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(I_n_samples/2ull,&sig_vsum_reference_im.m_data[0],nullptr,
                                              s4.c_str() ,"AM-BB_cos_signals_sequence",false);  
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cmplx_cos_sequence_correctness_sse_u6x();
...
void unit_test_am_bb_cmplx_cos_sequence_correctness_sse_u6x()
{
   ...
   //  const std::size_t   nsignals{rand_nsignals.operator()()};
     ...
     for(std::uint32_t i_case{0u}; i_case != 4u; ++i_case) 
     {
         ...
         std::int32_t ret_stat = cos_sequence.signal_sequence_sse42_u6x(&I_sym.m_data[0],pdf_params,am_bb_cmplx_cos_signal_rand_distr::cauchy,&rand_scales[0],&ret_codes.operator[](0),i_case);
         if(ret_stat<0) { 
         ...
         { 
            std::printf("[UNIT-TEST:] -- case=%d, plotting results\n",i_case);
            std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
            std::string s1 = "am_bb_cmplx_cos_seq_sse_u6x_re_correct_test_1_case_"+std::to_string(i_case);
            std::string s2 = "am_bb_cmplx_cos_signal_reference_vsumm_re_u6x_test_1_"+std::to_string(i_case);
         
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_re_sequence.m_data[0],nullptr,
                                              s1.c_str(),"AM-BB_cos_signals_sequence",false);
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(I_n_samples/2ull,&sig_vsum_reference_re.m_data[0],nullptr,
                                               s2.c_str(),"AM-BB_cos_signals_sequence",false);
            std::string s3 = "am_bb_cmplx_cos_seq_sse_u6x_im_correct_test_1_"+std::to_string(i_case);
            std::string s4 = "am_bb_cmplx_cos_signal_reference_vsumm_im_u6x_test_1_"+std::to_string(i_case);
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_im_sequence.m_data[0],nullptr,
                                              s3.c_str(),"AM-BB_cos_signals_sequence",false);
            am_bb_cmplx_cos_signal_sequence_t::create_sequence_plot(I_n_samples/2ull,&sig_vsum_reference_im.m_data[0],nullptr,
                                              s4.c_str() ,"AM-BB_cos_signals_sequence",false);  
...
int main()
{
     unit_test_am_bb_cmplx_cos_sequence_correctness_sse_u16x();
     unit_test_am_bb_cmplx_cos_sequence_correctness_sse_u10x();
     unit_test_am_bb_cmplx_cos_sequence_correctness_sse_u6x();
     return 0;
}