...
void unit_test_am_bb_cosine_sequence_rand_data_sse42_u16x()
{
     ...
     std::int32_t ret_stat = cos_sequence.signal_sequence_sse42_u16x(&I_sym.m_data[0],&ret_codes.operator[](0)); 
     if(ret_stat<0) { 
...
void unit_test_am_bb_cosine_sequence_correctness_sse42_u10x()
{
     ...
     */
     ...
     //cos_sequence.signal_sequence_avx_u16x_u(&I_sym.m_data[0],&ret_codes.operator[](0)); 
     std::int32_t ret_stat = cos_sequence.signal_sequence_sse42_u10x(&I_sym.m_data[0],&ret_codes.operator[](0));
     if(ret_stat<0) { 
...
void unit_test_am_bb_cosine_sequence_correctness_sse42_u6x()
{
     ...
     */
     ...
     //cos_sequence.signal_sequence_avx_u16x_u(&I_sym.m_data[0],&ret_codes.operator[](0)); 
     std::int32_t ret_stat = cos_sequence.signal_sequence_sse42_u6x(&I_sym.m_data[0],&ret_codes.operator[](0));
     if(ret_stat<0) { 
