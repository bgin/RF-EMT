...
void unit_test_am_bb_cosine_sequence_rand_data_avx_u16x()
{
     ...
     am_bb_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_cosine_sequence_avx_u16x_rand_data_test_1_","AM-BB_Cosine_Signals_Sequence",false);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cosine_sequence_correctness_avx_u16x();
...
void unit_test_am_bb_cosine_sequence_correctness_avx_u16x()
{
   ...
   //  const std::size_t   nsignals{rand_nsignals.operator()()};
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
     am_bb_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_cosine_sequence_avx_u16x_correctness_test_1_","AM-BB_Cosine_Signals_Sequence",false);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cosine_sequence_correctness_avx_u10x();
...
void unit_test_am_bb_cosine_sequence_correctness_avx_u10x()
{
     ...
     */
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
     am_bb_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_cosine_sequence_avx_u10x_correctness_test_1_","AM-BB_Cosine_Signals_Sequence",false);
     am_bb_cos_signal_sequence_t::create_sequence_plot(I_n_samples,&sig_vsum_reference.m_data[0],nullptr,
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cosine_sequence_correctness_avx_u6x();
...
void unit_test_am_bb_cosine_sequence_correctness_avx_u6x()
{
     ...
     */
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
     am_bb_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_cosine_sequence_avx_u6x_correctness_test_1_","AM-BB_Cosine_Signals_Sequence",false);
     am_bb_cos_signal_sequence_t::create_sequence_plot(I_n_samples,&sig_vsum_reference.m_data[0],nullptr,
...
void unit_test_am_bb_cosine_sequence_varying_params_avx_u16x()
{
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_cosine_sequence_avx_u16x_var_params_test_1_","AM-BB_Cosine_Signals_Sequence",false);
...
void unit_test_am_bb_cosine_sequence_rand_data_avx_u10x()
{
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_cosine_sequence_avx_u10x_rand_data_test_1_","AM-BB_Cosine_Signals_Sequence",false);
...
void unit_test_am_bb_cosine_sequence_rand_data_avx_u6x()
{
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_cosine_sequence_avx_u6x_trand_data_test_1_","AM-BB_Cosine_Signals_Sequence",false);
...
int main()
{
    ...
    unit_test_am_bb_cosine_sequence_correctness_avx_u16x();
    unit_test_am_bb_cosine_sequence_correctness_avx_u10x();
    unit_test_am_bb_cosine_sequence_correctness_avx_u6x();
    return 0;
}
