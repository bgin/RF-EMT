...
/*
   icpc -o unit_test_bessel_i0_ps -O3 -fp-model fast=2 -fno-exceptions -std=c++17 -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_bessel_i0_sse.h unit_test_bessel_i0_sse.cpp
   ASM: 
   icpc -S -O3 fverbose-asm -masm=intel  -std=c++17 -march=skylake-avx512 -mavx512f -falign-functions=32 GMS_config.h GMS_bessel_i0_sse.h unit_test_bessel_i0_sse.cpp
...
void unit_test_bessel_i0_sse_le_15();
...
void unit_test_bessel_i0_sse_le_15()
{
    ...
    __m128d    in_vref_vec{_mm_setr_pd(in_ref_1,in_ref_2)};
    ...
    printf("[UNIT-TEST]: -- Calling SSE implementation: bessel_i0_le15_sse_pd.\n");
    printf("[UNIT-TEST]: Inputs are: ref_1=%.17f,ref_2=%.17f\n",p_vref_in[0],p_vref_in[1]);
    //__asm__("int3");
    vec_actual_vref = bessel_i0_le15_sse_pd(in_vref_vec);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_bessel_i0_sse_ge_15();
...
void unit_test_bessel_i0_sse_ge_15()
{
    ...
    sca_expected_ref_1 = bessel_i0(in_ref_1,1);
    sca_expected_ref_2 = bessel_i0(in_ref_2,1);
    printf("[UNIT-TEST]: -- Calling SSE implementation: bessel_i0_ge15_sse_pd.\n");
    printf("[UNIT-TEST]: Inputs are: ref_1=%.17f,ref_2=%.17f\n",p_vref_in[0],p_vref_in[1]);
    //__asm__("int3");
    vec_actual_vref = bessel_i0_ge15_sse_pd(in_vref_vec);
    p_vref_out      = reinterpret_cast<double*>(&vec_actual_vref);
    //printf("[UNIT-TEST]: Calculating the results approximately equal by the epsilon:%.17f\n",std::numeric_limits<double>::epsilon());
    const bool ref_1_approx_equality{approximatelyEqual(sca_expected_ref_1,p_vref_out[0],std::numeric_limits<double>::epsilon())};
    const bool ref_2_approx_equality{approximatelyEqual(sca_expected_ref_2,p_vref_out[1],std::numeric_limits<double>::epsilon())};
...
int main()
{
    unit_test_bessel_i0_sse_le_15();
    unit_test_bessel_i0_sse_ge_15();
    return 0;
}