...
/*
   icpc -o unit_test_am_bb_trapez_signal_fp16 -fp-model fast=2 -std=c++17 -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_cos.h GMS_indices.h GMS_am_bb_trapez_signal_fp16.h GMS_am_bb_trapez_signal_fp16.cpp unit_test_am_bb_trapez_signal_fp16.cpp
   ASM: 
   icpc -S -fverbose-asm -masm=intel  -std=c++17 -march=skylake-avx512 -mavx512f -falign-functions=32 GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h  GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_cos.h GMS_indices.h GMS_am_bb_trapez_signal_fp16.h GMS_am_bb_trapez_signal_fp16.cpp unit_test_am_bb_trapez_signal_fp16.cpp

*/

__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_trapez_signal_fp16_rand_data_1();
...
void unit_test_am_bb_trapez_signal_fp16_rand_data_1()
{
     ...
     am_bb_trapez_signal_fp16_t symbol_1 = am_bb_trapez_signal_fp16_t(I_n_samples,I_n_K,I_a,I_m,I_l,I_c);
     ...
     am_bb_trapez_signal_fp16_t::create_signal_plot(symbol_1.m_nsamples,symbol_1.m_sig_samples.m_data,nullptr,
                                              "am_bb_trapez_signal_fp16_user_data_test_1_","AM_Baseband_Trapezoid_Signal",false);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_trapez_signal_fp16_rand_data_2();
...
void unit_test_am_bb_trapez_signal_fp16_rand_data_2()
{
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_trapez_signal_fp16_t::create_signal_plot(symbol_1.m_nsamples,symbol_1.m_sig_samples.m_data,nullptr,
                                              "am_bb_trapez_signal_fp16_user_data_test_2_","AM_Baseband_Trapezoid_Signal",false);
...
int main()
{   
    unit_test_am_bb_trapez_signal_fp16_rand_data_1();
    unit_test_am_bb_trapez_signal_fp16_rand_data_2();
    return 0;
}