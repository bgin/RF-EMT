...
void unit_test_matrix_inv_cholesky_13x13_validity();
...
void unit_test_matrix_inv_cholesky_13x13_validity()
{
    ...
    printf("[UNIT-TEST]: -- START: (Impl:RF-EMT) mat_inv_cholesky_13x13_16xf32<true,true> vs. (Impl:FlexRAN) matrix_inv_cholesky_13x13 (Validity).\n");
    seed_d = std::clock();
    ...
    switch (which)
    {
        case 0 : 
        {
            ...
            __ATTR_ALIGN__(64) __m512 matInvBReRef[MAT_SQR_SIZE_13][MAT_SQR_SIZE_13];
            __ATTR_ALIGN__(64) __m512 matInvBImRef[MAT_SQR_SIZE_13][MAT_SQR_SIZE_13];
             seed_re = __rdtsc();
            ...
            printf_ret = printf("[UNIT-TEST]: -- START: matrix_inv_cholesky_13x13(***FlexRAN(Reference)***).\n");
            tsc_start_flexr  = gms::common::rdtscp_fenced();
            matrix_inv_cholesky_13x13(matBRe,matBIm,matInvBReRef,matInvBImRef);
            ...
            printf_ret = printf("[UNIT-TEST]: -- END: mat_inv_cholesky_13x13_16xf32<true,true> vs matrix_inv_cholesky_13x13 (Validity).\n");
        ...
        case 1 : 
        {
            ...
            printf_ret = printf("[UNIT-TEST]: -- START: mat_inv_cholesky_13x13_16xf32<true,true> ***RF-EMT*** .\n");
            tsc_start_rf_emt  = gms::common::rdtscp_fenced();
            gms::math::mat_inv_cholesky_13x13_16xf32<true,true>(matBRe,matBIm,
                                                               matInvBRe,matInvBIm);
            tsc_end_rf_emt    = gms::common::rdtscp_fenced();
...
int main()
{   
    unit_test_matrix_inv_cholesky_13x13_validity();
    return 0;
}
