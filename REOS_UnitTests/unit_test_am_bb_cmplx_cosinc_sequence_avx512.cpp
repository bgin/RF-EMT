...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cmplx_cosinc_sequence_correctness_avx512_u16x();
...
void unit_test_am_bb_cmplx_cosinc_sequence_correctness_avx512_u16x()
{
   ...
   //  const std::size_t   nsignals{rand_nsignals.operator()()};
     ...
     for(std::uint32_t i_case{0u}; i_case != 4u; ++i_case) 
     {
         ...
         std::int32_t ret_stat = cosinc_sequence.signal_sequence_avx512_u16x(&I_sym.m_data[0],pdf_params,am_bb_cmplx_cosinc_signal_rand_distr::cauchy,&rand_scales[0],&ret_codes.operator[](0),i_case);
         if(ret_stat<0) { 
         ...
         { 
            ...
            std::string s1 = "am_bb_cmplx_cosinc_seq_av512_u16x_re_correct_test_1_case_"+std::to_string(i_case);
            ...
            std::string s3 = "am_bb_cmplx_cosinc_seq_avx512_u16x_im_correct_test_1_"+std::to_string(i_case);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cmplx_cosinc_sequence_correctness_avx512_u10x();
...
void unit_test_am_bb_cmplx_cosinc_sequence_correctness_avx512_u10x()
{
   ...
   //  const std::size_t   nsignals{rand_nsignals.operator()()};
     ...
     for(std::uint32_t i_case{0u}; i_case != 4u; ++i_case) 
     {
         ...
         std::int32_t ret_stat = cosinc_sequence.signal_sequence_avx512_u10x(&I_sym.m_data[0],pdf_params,am_bb_cmplx_cosinc_signal_rand_distr::cauchy,&rand_scales[0],&ret_codes.operator[](0),i_case);
         if(ret_stat<0) { 
         ...
         { 
            std::printf("[UNIT-TEST:] -- case=%d, plotting results\n",i_case);
            std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
            std::string s1 = "am_bb_cmplx_cosinc_seq_avx512_u10x_re_correct_test_1_case_"+std::to_string(i_case);
            ...
            am_bb_cmplx_cosinc_signal_sequence_t::create_sequence_plot(I_n_samples/2ull,&sig_vsum_reference_re.m_data[0],nullptr,
                                               s2.c_str(),"AM-BB_cosinc_signals_sequence",false);
            std::string s3 = "am_bb_cmplx_cosinc_seq_avx512_u10x_im_correct_test_1_"+std::to_string(i_case);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cmplx_cosinc_sequence_correctness_avx512_u6x();
...
void unit_test_am_bb_cmplx_cosinc_sequence_correctness_avx512_u6x()
{
   ...
   //  const std::size_t   nsignals{rand_nsignals.operator()()};
     ...
     for(std::uint32_t i_case{0u}; i_case != 4u; ++i_case) 
     {
         ...
         std::int32_t ret_stat = cosinc_sequence.signal_sequence_avx512_u6x(&I_sym.m_data[0],pdf_params,am_bb_cmplx_cosinc_signal_rand_distr::cauchy,&rand_scales[0],&ret_codes.operator[](0),i_case);
         if(ret_stat<0) { 
         ...
         { 
            std::printf("[UNIT-TEST:] -- case=%d, plotting results\n",i_case);
            std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
            std::string s1 = "am_bb_cmplx_cosinc_seq_avx512_u6x_re_correct_test_1_case_"+std::to_string(i_case);
            ...
            am_bb_cmplx_cosinc_signal_sequence_t::create_sequence_plot(I_n_samples/2ull,&sig_vsum_reference_re.m_data[0],nullptr,
                                               s2.c_str(),"AM-BB_cosinc_signals_sequence",false);
            std::string s3 = "am_bb_cmplx_cosinc_seq_avx512_u6x_im_correct_test_1_"+std::to_string(i_case);
...
int main()
{
     unit_test_am_bb_cmplx_cosinc_sequence_correctness_avx512_u16x();
     unit_test_am_bb_cmplx_cosinc_sequence_correctness_avx512_u10x();
     unit_test_am_bb_cmplx_cosinc_sequence_correctness_avx512_u6x();
     return 0;
}