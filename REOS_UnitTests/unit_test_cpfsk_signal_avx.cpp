...
unit_test_cpfsk_avx_rolled()
{
     ...
     // CPFSK state variables
     constexpr std::size_t cpfsk_T{I_nsamples/20};
     constexpr std::size_t nfreqs{20};
     constexpr std::uint32_t cpfsk_k{500u};
     constexpr float cpfsk_A{1.475f};
     constexpr float cpfsk_h{0.758f};
     constexpr float cpfsk_fc{3500000.452f};
     constexpr float cpfsk_ph0{0.78539816339744830961566084582f};
     // CPFSK end.
...
*/      
      ...
      std::int32_t ret_status = IQ_rectw_bitstream_vseq.generate_iq_rectw_bitstream_sequence_sse_u16x<iq_rectw_bitstream_vsequence_t
      ...
      if(ret_status<0)
      {
             std::printf("[UNIT-TEST]: -- generate_iq_rectw_bitstream_sequence_sse_u16x -- **FAILED**, status=%d\n",ret_status);
             return;
      }
      else 
      {
...
/*
      ...
      iq_rectw_bitstream_vsequence_t::create_sequence_plot(static_cast<std::int32_t>(IQ_rectw_bitstream_vseq.m_I_nsamples),
                                                           ...
                                                           "generate_iq_rectw_bitstream_I_sequence_sse_u16x_test_3_",
      ...
      iq_rectw_bitstream_vsequence_t::create_sequence_plot(static_cast<std::int32_t>(IQ_rectw_bitstream_vseq.m_Q_nsamples),
                                                           ...
                                                           "generate_iq_rectw_bitstream_Q_sequence_sse_u16x_test_3_",
                                                           "Q-channel vertically summed",false); 
*/      

      std::printf("[UNIT-TEST:] -- Creating the cpfsk_signal_t object.\n");

      cpfsk_signal_t cpfsk_signal_pulse_1 = cpfsk_signal_t(cpfsk_T,nfreqs,cpfsk_k,cpfsk_A,cpfsk_h,cpfsk_fc,cpfsk_ph0);
      ...
      std::int32_t state_generate_cpfsk_signal_avx{-9999};
      ...
      if(__builtin_expect(state_compute_Phik!=0,0)) 
      {
           std::printf("[FAIL] -- compute_Phik returned a errorenous state value=%d\n",state_compute_Phik);
           return;
      }
      state_generate_cpfsk_signal_avx = cpfsk_signal_pulse_1.generate_cpfsk_signal_avx(ak_I,true);
      if(__builtin_expect(state_generate_cpfsk_signal_avx!=0,0))
      {
           std::printf("[FAIL] -- generate_cpfsk_signal_avx returned a errorenous state value=%d\n",state_generate_cpfsk_signal_avx);
           return;
      }
      std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
      cpfsk_signal_t::create_sequence_plot(static_cast<std::int32_t>(cpfsk_signal_pulse_1.m_T),
                                           ...
                                           "unit_test_cpfsk_avx_rolled_test_I_ch_1_","CPFSK signal user data I-channel",false);   
      cpfsk_signal_pulse_1.clear_cpfsk_signal(0.0f);
      state_compute_Phik = -9999;
      state_generate_cpfsk_signal_avx = -9999;
      ...
      state_generate_cpfsk_signal_avx = cpfsk_signal_pulse_1.generate_cpfsk_signal_avx(ak_Q,true);
      if(__builtin_expect(state_generate_cpfsk_signal_avx!=0,0))
      {
           std::printf("[FAIL] -- generate_cpfsk_signal_avx returned a errorenous state value=%d\n",state_generate_cpfsk_signal_avx);
           return;
      ...
      cpfsk_signal_t::create_sequence_plot(static_cast<std::int32_t>(cpfsk_signal_pulse_1.m_T),
                                           cpfsk_signal_pulse_1.m_cpfsk_signal.m_data,nullptr,
                                           "unit_test_cpfsk_avx_rolled_test_Q_ch_1_","CPFSK signal user data Q-channel",false);
...
*/      
      ...
      state_generate_cpfsk_signal_avx = cpfsk_signal_pulse_1.generate_cpfsk_signal_avx_u8x(ak_I,true);
      if(__builtin_expect(state_generate_cpfsk_signal_avx!=0,0))
      {
           std::printf("[FAIL] -- generate_cpfsk_signal_avx_u8x returned a errorenous state value=%d\n",state_generate_cpfsk_signal_avx);
           return;
      }
      std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
      cpfsk_signal_t::create_sequence_plot(static_cast<std::int32_t>(cpfsk_signal_pulse_1.m_T),
                                           cpfsk_signal_pulse_1.m_cpfsk_signal.m_data,nullptr,
                                           "unit_test_cpfsk_avx_u8x_test_I_ch_1_","CPFSK signal user data I-channel",false);   
      cpfsk_signal_pulse_1.clear_cpfsk_signal(0.0f);
      state_compute_Phik = -9999;
      state_generate_cpfsk_signal_avx = -9999;
      std::memcpy(&cpfsk_user_data_Q.m_data[0],&IQ_rectw_bitstream_vseq.m_Q_vsequence.m_data[0],sizeof(float)*500ull);
      ...
      state_generate_cpfsk_signal_avx = cpfsk_signal_pulse_1.generate_cpfsk_signal_avx_u8x(ak_Q,true);
      if(__builtin_expect(state_generate_cpfsk_signal_avx!=0,0))
      {
           std::printf("[FAIL] -- generate_cpfsk_signal_avx_u8x returned a errorenous state value=%d\n",state_generate_cpfsk_signal_avx);
           return;
      ...
      cpfsk_signal_t::create_sequence_plot(static_cast<std::int32_t>(cpfsk_signal_pulse_1.m_T),
                                           cpfsk_signal_pulse_1.m_cpfsk_signal.m_data,nullptr,
                                           "unit_test_cpfsk_avx_u8x_test_Q_ch_1_","CPFSK signal user data Q-channel",false);
      std::printf("[UNIT_TEST]: function=%s -- **END**\n", __PRETTY_FUNCTION__);
