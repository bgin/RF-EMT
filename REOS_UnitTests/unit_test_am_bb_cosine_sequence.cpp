...
/*
   icpc -o unit_test_am_bb_scosine_sequence -O3 -fp-model fast=2 -std=c++17 -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_cos.h GMS_indices.h GMS_am_bb_cosine_signal.h GMS_am_bb_cosine_signal.cpp GMS_am_bb_cosine_sequence.h GMS_am_bb_cosine_sequence.cpp unit_test_am_bb_cosine_sequence.cpp
   ASM: 
   icpc -S --O3 fverbose-asm -masm=intel  -std=c++17 -march=skylake-avx512 -mavx512f -falign-functions=32 GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h  GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_cos.h GMS_indices.h GMS_am_bb_cosine_sequence.h GMS_am_bb_cosine_sequence.cpp unit_test_am_bb_cosine_sequence.cpp

*/

__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cosine_sequence_rand_data_1();
...
void unit_test_am_bb_cosine_sequence_rand_data_1()
{
     ...
     cos_sequence.signal_sequence_sse42_u16x_u(&I_sym.m_data[0],&ret_codes.operator[](0));     
     ...
     am_bb_cos_signal_sequence_t::create_sequence_plot(cos_sequence.m_nsamples,&cos_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_cosine_sequence_user_data_test_1_","AM-BB_Cosine_Signals_Sequence",false);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cosine_signal_rand_data_2();
...
void unit_test_am_bb_cosine_signal_rand_data_2()
{
     ...
     //std::cout << __cmplx_trapw_env__ << std::endl;
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_cosine_signal_t::create_signal_plot(symbol_1.m_nsamples,symbol_1.m_sig_samples.m_data,nullptr,
                                              "am_bb_cosine_signal_user_data_test_2_2","AM_Baseband_CosineWave_Signal",false);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cosine_signal_rand_data_3();
...
void unit_test_am_bb_cosine_signal_rand_data_3()
{
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_cosine_signal_t::create_signal_plot(symbol_1.m_nsamples,symbol_1.m_sig_samples.m_data,nullptr,
                                              "am_bb_cosine_signal_user_data_test_3_","AM_Baseband_CosineWave_Signal",false);
...
int main()
{
    unit_test_am_bb_cosine_sequence_rand_data_1();
    //unit_test_am_bb_cosine_signal_rand_data_2();
    //unit_test_am_bb_cosine_signal_rand_data_3();
    return 0;
}
