...
/*
   icpc -o unit_test_matrix_inv_cholesky_10x10_validity -std=c++17 -fp-model fast=2 -ftz -ggdb -ipo -qopt-zmm-usage=high -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_malloc.h GMS_machine_utils.h GMS_matrix_inv_cholesky.h GMS_matrix_inv_cholesky.cpp unit_test_mat_inv_cholesky_defines.h unit_test_inv_mat_cholesky_10x10_validity.cpp 
   ASM: 
   icpc -S -fverbose-asm -masm=intel -qopt-zmm-usage=high -march=skylake-avx512 -mavx512f -falign-functions=32 GMS_config.h GMS_config.h GMS_malloc.h GMS_machine_utils.h GMS_matrix_inv_cholesky.h GMS_matrix_inv_cholesky.cpp unit_test_mat_inv_cholesky_defines.h unit_test_inv_mat_cholesky_10x10_validity.cpp 
*/
...
void unit_test_matrix_inv_cholesky_10x10_validity();

void unit_test_matrix_inv_cholesky_10x10_validity()
{
    using namespace gms::math;
    constexpr int32_t nelems{1600};
    ...
    printf("[UNIT-TEST]: -- START: (Impl:RF-EMT) mat_inv_cholesky_10x10_16xf32<true,true> vs. (Impl:FlexRAN) matrix_inv_cholesky_10x10 (Validity).\n");
    seed_d = std::clock();
    ...
    switch (which)
    {
        case 0 : 
        {
            ...
            __ATTR_ALIGN__(64) __m512 matBRe[MAT_SQR_SIZE_10][MAT_SQR_SIZE_10];
            __ATTR_ALIGN__(64) __m512 matBIm[MAT_SQR_SIZE_10][MAT_SQR_SIZE_10];
            __ATTR_ALIGN__(64) __m512 matInvBRe[MAT_SQR_SIZE_10][MAT_SQR_SIZE_10];
            __ATTR_ALIGN__(64) __m512 matInvBIm[MAT_SQR_SIZE_10][MAT_SQR_SIZE_10];
            __ATTR_ALIGN__(64) __m512 matInvBReRef[MAT_SQR_SIZE_10][MAT_SQR_SIZE_10];
            __ATTR_ALIGN__(64) __m512 matInvBImRef[MAT_SQR_SIZE_10][MAT_SQR_SIZE_10];
             seed_re = __rdtsc();
            ...
            for(std::int32_t i = 0;i != MAT_SQR_SIZE_10; ++i)
            {   
                const std::int32_t outer_idx = i*MAT_SQR_SIZE_10;
                for(std::int32_t j = 0;j != MAT_SQR_SIZE_10; ++j)  
                {
            ...
            printf_ret = printf("[UNIT-TEST]: -- START: mat_inv_cholesky_10x10_16xf32<true,true>.\n");
            tsc_start_rf_emt = gms::common::rdtscp_fenced();
            gms::math::mat_inv_cholesky_10x10_16xf32<true,true>(matBRe,matBIm,
                                                               matInvBRe,matInvBIm); 
            ...
            printf_ret = printf("[UNIT-TEST]: -- START: matrix_inv_cholesky_10x10(***FlexRAN(Reference)***).\n");
            tsc_start_flexr  = gms::common::rdtscp_fenced();
            matrix_inv_cholesky_10x10(matBRe,matBIm,matInvBReRef,matInvBImRef);
            ...
            printf_ret = printf("[UNIT-TEST]: -- END: mat_inv_cholesky_10x10_16xf32<true,true> vs matrix_inv_cholesky_9x9 (Validity).\n");
        ...
        case 1 : 
        {
            ...
            printf_ret = printf("[UNIT-TEST]: -- START: mat_inv_cholesky_10x10_16xf32<true,true> ***RF-EMT*** .\n");
            tsc_start_rf_emt  = gms::common::rdtscp_fenced();
            gms::math::mat_inv_cholesky_10x10_16xf32<true,true>(matBRe,matBIm,
                                                               matInvBRe,matInvBIm);
            tsc_end_rf_emt    = gms::common::rdtscp_fenced();
            ...
            PRINT_CRUDE_TIMING_RESULTS;
            printf_ret = printf("[UNIT-TEST]: -- END: mat_inv_cholesky_10x10_16xf32<true,true> vs matrix_inv_cholesky_10x10 (Validity).\n");
        }
        break;
        case 2 : 
        {
...
int main()
{   
    unit_test_matrix_inv_cholesky_10x10_validity();
    return 0;
}
