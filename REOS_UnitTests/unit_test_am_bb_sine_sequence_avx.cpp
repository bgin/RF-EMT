...
/*
   icpc -o unit_test_am_bb_sine_sequence_avx -O3 -fp-model fast=2 -std=c++17 -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_sine.h GMS_indices.h GMS_am_bb_sine_signal.h GMS_am_bb_sine_signal.cpp GMS_am_bb_sine_sequence.h GMS_am_bb_sine_sequence.cpp unit_test_am_bb_sine_sequence_avx.cpp
   ASM: 
   icpc -S --O3 fverbose-asm -masm=intel  -std=c++17 -march=skylake-avx512 -mavx512f -falign-functions=32 GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h  GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_sine.h GMS_indices.h GMS_am_bb_sine_sequence.h GMS_am_bb_sine_sequence.cpp unit_test_am_bb_sine_sequence_avx.cpp

*/

__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_sine_sequence_rand_data_avx_u16x();
...
void unit_test_am_bb_sine_sequence_rand_data_avx_u16x()
{
     ...
     std::int32_t ret_stat = sine_sequence.signal_sequence_avx_u16x(&I_sym.m_data[0],&ret_codes.operator[](0),which_func); 
     if(ret_stat<0) { 
     ...
     am_bb_sine_signal_sequence_t::create_sequence_plot(sine_sequence.m_nsamples,&sine_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_sine_sequence_avx_u16x_rand_data_test_1_","AM-BB_Sine_Signals_Sequence",false);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_sine_sequence_correctness_avx_u16x();
...
void unit_test_am_bb_sine_sequence_correctness_avx_u16x()
{
   ...
   //  const std::size_t   nsignals{rand_nsignals.operator()()};
     ...
     std::int32_t ret_stat = sine_sequence.signal_sequence_avx_u16x(&I_sym.m_data[0],&ret_codes.operator[](0),0);
     if(ret_stat<0) { 
        std::printf("[UNIT-TEST:] -- **FAIL** -> signal_sequence_avx_u16x stat=%d\n",ret_stat);
        return;
     }
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
     am_bb_sine_signal_sequence_t::create_sequence_plot(sine_sequence.m_nsamples,&sine_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_sine_sequence_avx_u16x_correctness_test_1_","AM-BB_sine_Signals_Sequence",false);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_sine_sequence_correctness_avx_u10x();
...
void unit_test_am_bb_sine_sequence_correctness_avx_u10x()
{
     ...
     */
     ...
     //sine_sequence.signal_sequence_avx_u16x_u(&I_sym.m_data[0],&ret_codes.operator[](0)); 
     std::int32_t ret_stat = sine_sequence.signal_sequence_avx_u10x(&I_sym.m_data[0],&ret_codes.operator[](0),0);
     if(ret_stat<0) { 
        std::printf("[UNIT-TEST:] -- **FAIL** -> signal_sequence_avx_u10x stat=%d\n",ret_stat);
        return;
     } 
     std::printf("[UNIT-TEST:] -- Calling  sineine wave components modulated by the user data -- vertically summed sequence (REFERENCE!!).\n\n");
     symbol_1.create_signal_user_data(&I_sym.m_data[0],I_n_samples,I_n_K);
     symbol_2.create_signal_user_data(&I_sym.m_data[0],I_n_samples,I_n_K); 
     symbol_3.create_signal_user_data(&I_sym.m_data[0],I_n_samples,I_n_K);
     symbol_4.create_signal_user_data(&I_sym.m_data[0],I_n_samples,I_n_K);
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
     am_bb_sine_signal_sequence_t::create_sequence_plot(sine_sequence.m_nsamples,&sine_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_sine_sequence_avx_u10x_correctness_test_1_","AM-BB_sine_Signals_Sequence",false);
     am_bb_sine_signal_sequence_t::create_sequence_plot(I_n_samples,&sig_vsum_reference.m_data[0],nullptr,
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_sine_sequence_correctness_avx_u6x();
...
void unit_test_am_bb_sine_sequence_correctness_avx_u6x()
{
     ...
     */
     ...
     //sine_sequence.signal_sequence_avx_u16x_u(&I_sym.m_data[0],&ret_codes.operator[](0)); 
     std::int32_t ret_stat = sine_sequence.signal_sequence_avx_u6x(&I_sym.m_data[0],&ret_codes.operator[](0),0);
     if(ret_stat<0) { 
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n\n");
     am_bb_sine_signal_sequence_t::create_sequence_plot(sine_sequence.m_nsamples,&sine_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_sine_sequence_avx_u6x_correctness_test_1_","AM-BB_sine_Signals_Sequence",false);
     am_bb_sine_signal_sequence_t::create_sequence_plot(I_n_samples,&sig_vsum_reference.m_data[0],nullptr,
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_sine_sequence_varying_params_avx_u16x();
...
void unit_test_am_bb_sine_sequence_varying_params_avx_u16x()
{
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_sine_signal_sequence_t::create_sequence_plot(sine_sequence.m_nsamples,&sine_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_sine_sequence_avx_u16x_var_params_test_1_","AM-BB_sine_Signals_Sequence",false);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_sine_sequence_rand_data_avx_u10x();
...
void unit_test_am_bb_sine_sequence_rand_data_avx_u10x()
{
     ...
     auto rand_func{std::bind(std::uniform_int_distribution<std::uint32_t>(0,1),std::mt19937(seed_func))};
     const std::uint32_t which_func{rand_func()};
     std::int32_t ret_stat = sine_sequence.signal_sequence_avx_u10x(&I_sym.m_data[0],&ret_codes.operator[](0),which_func); 
     if(ret_stat<0) { 
        std::printf("[UNIT-TEST:] -- **FAIL** -> signal_sequence_avx_u10x stat=%d\n",ret_stat);
        return;
     }    
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_sine_signal_sequence_t::create_sequence_plot(sine_sequence.m_nsamples,&sine_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_sine_sequence_avx_u10x_rand_data_test_1_","AM-BB_sine_Signals_Sequence",false);
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_sine_sequence_rand_data_avx_u6x();
...
void unit_test_am_bb_sine_sequence_rand_data_avx_u6x()
{
     ...
     auto rand_func{std::bind(std::uniform_int_distribution<std::uint32_t>(0,1),std::mt19937(seed_func))};
     const std::uint32_t which_func{rand_func()};
     std::int32_t ret_stat = sine_sequence.signal_sequence_avx_u6x(&I_sym.m_data[0],&ret_codes.operator[](0),which_func);  
     if(ret_stat<0) { 
        std::printf("[UNIT-TEST:] -- **FAIL** -> signal_sequence_avx_u6x stat=%d\n",ret_stat);
        return;
     }   
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_sine_signal_sequence_t::create_sequence_plot(sine_sequence.m_nsamples,&sine_sequence.m_vsummed_sequence.operator[](0),nullptr,
                                              "am_bb_sine_sequence_avx_u6x_trand_data_test_1_","AM-BB_sine_Signals_Sequence",false);
...
int main()
{
    unit_test_am_bb_sine_sequence_rand_data_avx_u16x();
    unit_test_am_bb_sine_sequence_rand_data_avx_u10x();
    unit_test_am_bb_sine_sequence_rand_data_avx_u6x();
    unit_test_am_bb_sine_sequence_varying_params_avx_u16x();
    unit_test_am_bb_sine_sequence_correctness_avx_u16x();
    unit_test_am_bb_sine_sequence_correctness_avx_u10x();
    unit_test_am_bb_sine_sequence_correctness_avx_u6x();
    return 0;
}
