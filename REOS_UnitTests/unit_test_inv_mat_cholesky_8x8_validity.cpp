...
/*
   icpc -o unit_test_matrix_inv_cholesky_8x8_validity -std=c++17 -fp-model fast=2 -ftz -ggdb -ipo -qopt-zmm-usage=high -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_malloc.h GMS_matrix_inv_cholesky.h GMS_matrix_inv_cholesky.cpp unit_test_mat_inv_cholesky_defines.h unit_test_inv_mat_cholesky_8x8_validity.cpp 
   ASM: 
   icpc -S -fverbose-asm -masm=intel -qopt-zmm-usage=high -march=skylake-avx512 -mavx512f -falign-functions=32 GMS_config.h GMS_config.h GMS_malloc.h GMS_matrix_inv_cholesky.h GMS_matrix_inv_cholesky.cpp unit_test_mat_inv_cholesky_defines.h unit_test_inv_mat_cholesky_8x8_validity.cpp 
*/
...
void unit_test_matrix_inv_cholesky_8x8_validity();
...
void unit_test_matrix_inv_cholesky_8x8_validity()
{
    ...
    printf("[UNIT-TEST]: -- START: (Impl:RF-EMT) mat_inv_cholesky_8x8_16xf32<true,true> vs. (Impl:FlexRAN) matrix_inv_cholesky_8x8 (Validity).\n");
    seed_d = std::clock();
    ...
    switch (which)
    {
        case 0 : 
        {
            ...
            __ATTR_ALIGN__(64) __m512 matInvBReRef[8][8];
            __ATTR_ALIGN__(64) __m512 matInvBImRef[8][8];
             seed_re = __rdtsc();
            ...
            printf_ret = printf("[UNIT-TEST]: -- START: mat_inv_cholesky_8x8_16xf32<true,true>.\n");
            ...
            printf_ret = printf("[UNIT-TEST]: -- START: matrix_inv_cholesky_8x8(***FlexRAN(Reference)***).\n");
            matrix_inv_cholesky_8x8(matBRe,matBIm,matInvBReRef,matInvBImRef);
            ...
            if(!bim_err_count) {printf_ret = printf("[UNIT_TEST:] -- Validity Test: (Q-channel): ***PASSED***\n");}
             ...
             printf_ret = printf("[UNIT-TEST]: -- END: mat_inv_cholesky_8x8_16xf32<true,true> vs matrix_inv_cholesky_8x8 (Validity).\n");
        ...
        case 1 : 
        {
            ...
            printf("[UNIT-TEST]: -- START: mat_inv_cholesky_8x8_16xf32<true,true> ***RF-EMT*** .\n");
            gms::math::mat_inv_cholesky_8x8_16xf32<true,true>(matBRe,matBIm,
                                                               matInvBRe,matInvBIm);
            ptr_invBRe = reinterpret_cast<const float * __restrict>(&matInvBRe);
            ptr_invBIm = reinterpret_cast<const float * __restrict>(&matInvBIm);
        ...
        case 2 : 
        {
            ...
            printf_ret = printf("[UNIT-TEST]: -- START: mat_inv_cholesky_8x8_16xf32<true,true> ***RF-EMT*** .\n");
            gms::math::mat_inv_cholesky_8x8_16xf32<true,true>(matBRe,matBIm,
                                                               matInvBRe,matInvBIm);
            ptr_invBRe = reinterpret_cast<const float * __restrict>(&matInvBRe);
            ptr_invBIm = reinterpret_cast<const float * __restrict>(&matInvBIm);
...
int main()
{   
    unit_test_matrix_inv_cholesky_8x8_validity();
    return 0;
}
