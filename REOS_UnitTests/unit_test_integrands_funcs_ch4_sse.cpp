...
void unit_test_integrand_4_1_gauss_Q_func_sse_pd()
{
    ...
    __ATTR_ALIGN__(16) double in_buf[n_func_args*n_gauss_q_vals];
    __ATTR_ALIGN__(16) double out_buf[n_func_args*n_gauss_q_vals];
    ...
    for(std::int32_t i = 0; i != ROUND_TO_FOUR(tot_elems,1); i += 2)
    {
