...
#include "GMS_am_bb_cmplx_cos_signal_fp16.h"

/*
   icpc -o unit_test_am_bb_cmplx_cos_signal_fp16 -fp-model fast=2 -std=c++17 -ftz -ggdb -ipo -march=skylake-avx512 -mavx512f -falign-functions=32 -w1 -qopt-report=5  \
   GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_cos.h GMS_indices.h GMS_am_bb_cmplx_cos_signal_fp16.h GMS_am_bb_cmplx_cos_signal_fp16.cpp unit_test_am_bb_cmplx_cos_signal_fp16.cpp
   ASM: 
   icpc -S -fverbose-asm -masm=intel  -std=c++17 -march=skylake-avx512 -mavx512f -falign-functions=32 GMS_config.h GMS_malloc.h GMS_fast_pmc_access.h  GMS_half.h GMS_dyn_array.h GMS_sse_memset.h GMS_sse_memset.cpp GMS_cephes_sin_cos.h GMS_indices.h GMS_am_bb_cmplx_cos_signal_fp16.h GMS_am_bb_cos_trapez_signal_fp16.cpp unit_test_am_bb_cmplx_cos_signal.cpp

*/

__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cmplx_cos_signal_fp16();
...
void unit_test_am_bb_cmplx_cos_signal_fp16()
{
     ...
     am_bb_cmplx_cos_signal_fp16_t symbol_1 = am_bb_cmplx_cos_signal_fp16_t(I_n_samples,I_n_K,n,A,P);
     ...
     */
     ...
     am_bb_cmplx_cos_signal_fp16_t::create_signal_plot(Re_n_samples,p_re,nullptr,
                                              "am_bb_cmplx_cos_signal_fp16_I_test_1_","I-channel",false);
     am_bb_cmplx_cos_signal_fp16_t::create_signal_plot(Re_n_samples,p_im,nullptr,
                                              "am_bb_cmplx_cos_signal_fp16_Q_test_1_","Q-channel",false);                                         
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cmplx_cos_noisy_signal_fp16();
...
void unit_test_am_bb_cmplx_cos_noisy_signal_fp16()
{
     ...
     constexpr float n{16.0f};
     constexpr float P{8.0f};
     am_bb_cmplx_cos_signal_fp16_pdf_params_t pdf_params;
     darray_r4_t I_sym; 
     std::clock_t seed_I;
     float scale{0.01f};
     constexpr std::size_t I_sym_len{I_n_samples*static_cast<std::size_t>(I_n_K)};
     ...
     */
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_cmplx_cos_signal_fp16_t::create_signal_plot(Re_n_samples,p_re,nullptr,
                                              "am_bb_cmplx_cos_noisy_signal_fp16_I_test_1_","I-channel",false);
     am_bb_cmplx_cos_signal_fp16_t::create_signal_plot(Re_n_samples,p_im,nullptr,
                                              "am_bb_cmplx_cos_noisy_signal_fp16_Q_test_1_","Q-channel",false);                                         
...
__attribute__((hot))
__attribute__((noinline))
void unit_test_am_bb_cmplx_cos_noisy_signal_fp16_2();
...
void unit_test_am_bb_cmplx_cos_noisy_signal_fp16_2()
{
     ...
     std::printf("[UNIT-TEST:] -- Calling  cosine wave components modulated by the user data and noise corrupted.\n");
     //std::int32_t stat_I = symbol_1.create_signal_user_data(&I_sym.m_data[0],static_cast<std::uint32_t>(I_n_samples),I_n_K);
     std::int32_t stat_I{symbol_1.create_noisy_signal_user_data(pdf_params,am_bb_cmplx_cos_signal_fp16_rand_distr::cauchy,scale,&I_sym.m_data[0],static_cast<std::uint32_t>(I_n_samples),I_n_K)};
     if(stat_I!=0)
     {
          std::printf("[UNIT-TEST:] -- chan_I_data_symbol failed -- error=%d\n",stat_I);
          return;
     ...
     */
     ...
     std::printf("[UNIT-TEST:] -- Creating gnuplot plotting command file.\n");
     am_bb_cmplx_cos_signal_fp16_t::create_signal_plot(Re_n_samples,p_re,nullptr,
                                              "am_bb_cmplx_cos_noisy_cauchy_signal_fp16_I_test_1_","I-channel",false);
     am_bb_cmplx_cos_signal_fp16_t::create_signal_plot(Re_n_samples,p_im,nullptr,
                                              "am_bb_cmplx_cos_noisy_cauchy_signal_fp16_Q_test_1_","Q-channel",false);                                         
...
int main()
{
     unit_test_am_bb_cmplx_cos_signal_fp16();
     unit_test_am_bb_cmplx_cos_noisy_signal_fp16();
     unit_test_am_bb_cmplx_cos_noisy_signal_fp16_2();
     return 0;
}
